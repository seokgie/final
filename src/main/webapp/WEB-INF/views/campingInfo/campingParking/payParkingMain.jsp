...
$('document').ready(function(){
	...
	$('g[role="menuitem"]:eq(0)').on("click",function(){
		console.log("0클릭");
		location.href="../reserve/campingDetail/${rank.get(0).getDivisionNum()}";
	});	
	
	$('g[role="menuitem"]:eq(1)').on("click",function(){
		console.log("1클릭");
		location.href="../reserve/campingDetail/${rank.get(1).getDivisionNum()}";
	});
	
	$('g[role="menuitem"]:eq(2)').on("click",function(){
		console.log("2클릭");
		location.href="../reserve/campingDetail/${rank.get(2).getDivisionNum()}";
	});
	
	$('g[role="menuitem"]:eq(3)').on("click",function(){
		console.log("3클릭");
		location.href="../reserve/campingDetail/${rank.get(3).getDivisionNum()}";
	});
	
	$('g[role="menuitem"]:eq(4)').on("click",function(){
		console.log("4클릭");
		location.href="../reserve/campingDetail/${rank.get(4).getDivisionNum()}";
	});
	
	$('g[role="menuitem"]:eq(5)').on("click",function(){
		console.log("5클릭");
		location.href="../reserve/campingDetail/${rank.get(5).getDivisionNum()}";
	});
	
	$('g[role="menuitem"]:eq(6)').on("click",function(){
		console.log("6클릭");
		location.href="../reserve/campingDetail/${rank.get(6).getDivisionNum()}";
	});
