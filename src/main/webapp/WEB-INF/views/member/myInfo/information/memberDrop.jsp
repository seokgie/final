            ...
            <div id="ss" class="py-3">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">* 사용하고 계신 아이디는 탈퇴할 경우 재사용 및 복구가
                        ...
                        바랍니다. 작성하신 댓글이나 게시물은 삭제하지 않으면 모두 남아있습니다.
                    </li>
                </ul>
...
제6조(회원가입)
  ...
  ④ 회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간 이내에 “몰”에 대하여
                ...
                <div class="col text-center">
                    <form action="${path}/myInfo/memberDropReal" method="post" id="delForm">
                        <input id="dropbtn" class="btn btn-warning mx-2" type="button" value="탈퇴하기">
                    </form>
                </div>
            </div>
        </div>
