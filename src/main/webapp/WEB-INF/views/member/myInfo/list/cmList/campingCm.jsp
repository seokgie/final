            ...
            <div class="container">
                <c:if test="${fn:length(map.list) ne 0}">
                    <table class="table table-hover mt-3">
                        <thead>
                        <tr>
                            <th class="fs-5 col-3" scope="col">캠핑장이름</th>
                    ...
                    <ul class="pagination justify-content-center">
                        <c:if test="${map.startPage ne 1}">
                            <li class="page-item">
                                <a class="page-link" href="${path}/myInfo/cmList/${map.startPage-1}/camping"
                                   aria-label="Previous">
                        ...
                        <c:forEach var="i" begin="${map.startPage}" end="${map.endPage}">
                            <c:if test="${i ne map.currPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${path}/myInfo/cmList/${i}/camping">${i}</a>
                                </li>
                            </c:if>
                        ...
                        <c:if test="${map.totalPage ne map.endPage}">
                            <li class="page-item">
                                <a class="page-link" href="${path}/myInfo/cmList/${map.endPage+1}/camping"
                                   aria-label="Next">
