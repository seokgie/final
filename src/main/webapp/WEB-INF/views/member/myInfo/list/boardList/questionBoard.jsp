                ...
                <c:if test="${fn:length(map.list) ne 0}">
                    ...
                    <ul class="pagination justify-content-center">
                        <c:if test="${map.startPage ne 1}">
                            <li class="page-item">
                                <a class="page-link" href="${path}/myInfo/boardList/${map.startPage-1}/questionBoard"
                                   aria-label="Previous">
                        ...
                        <c:forEach var="i" begin="${map.startPage}" end="${map.endPage}">
                            <c:if test="${i ne map.currPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${path}/myInfo/boardList/${i}/questionBoard">${i}</a>
                                </li>
                            </c:if>
                        ...
                        <c:if test="${map.totalPage ne map.endPage}">
                            <li class="page-item">
                                <a class="page-link" href="${path}/myInfo/boardList/${map.endPage+1}/questionBoard"
                                   aria-label="Next">
