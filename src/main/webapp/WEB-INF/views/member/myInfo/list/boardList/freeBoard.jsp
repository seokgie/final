                ...
                <c:if test="${fn:length(map.list) ne 0}">
                        ...
                        <c:forEach items="${map.list}" var="lists">
                            <tr>
                                <td class="py-3 align-middle"><a
                                        href="${path}/campingTalk/freeDetail/${lists.boardNum}">${lists.title}</a>
                                </td>
                    ...
                    <ul class="pagination justify-content-center">
                        <c:if test="${map.startPage ne 1}">
                            <li class="page-item">
                                <a class="page-link" href="${path}/myInfo/boardList/${map.startPage-1}/freeBoard"
                                   aria-label="Previous">
                        ...
                        <c:forEach var="i" begin="${map.startPage}" end="${map.endPage}">
                            <c:if test="${i ne map.currPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="${path}/myInfo/boardList/${i}/freeBoard">${i}</a>
                                </li>
                            </c:if>
                        ...
                        <c:if test="${map.totalPage ne map.endPage}">
                            <li class="page-item">
                                <a class="page-link" href="${path}/myInfo/boardList/${map.endPage+1}/freeBoard"
                                   aria-label="Next">
